...
CONNECTORS = [
    ...
    ("tiktok", "destination", "TikTok", "api_key", None, "disabled"),
    ("snapchat", "destination", "Snapchat", "api_key", None, "disabled"),
    ("linkedin", "destination", "LinkedIn", "oauth2", None, "disabled"),
    ...
    ("x", "destination", "X (Twitter)", "oauth2", None, "disabled"),
    # ── Meta sub-destinations ────────────────────────────────────────────────
    ("meta_conversions_api", "destination", "Conversions API", "api_key", "meta", "inactive"),
    ...
    ("google_enhanced_conversions", "destination", "Enhanced Conversions", "oauth2", "google", "inactive"),
    ...
    ("google_offline_conversions", "destination", "Offline Conversions", "oauth2", "google", "active"),
